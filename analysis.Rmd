...
![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/dds_disp.svg)
...
![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/dds_pca.svg)

```{r, cache=FALSE, eval=TRUE, fig.height=4.5, fig.width=4.5, fig.align='center'}
plotMA(dds, alpha=0.05, ylim=c(-7, 7))
```

![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/dds_ma.svg)
...
![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/ddss_disp.svg)
...
![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/ddss_pca.svg)

```{r, cache=FALSE, eval=TRUE, fig.height=4.5, fig.width=4.5, fig.align='center'}
plotMA(ddsS, alpha=0.05, ylim=c(-5, 5))
```

![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/ddss_ma.svg)
...
![](https://github.com/Perugolate/ec_rnaseq/blob/master/plots/ddsall_pca.svg)
